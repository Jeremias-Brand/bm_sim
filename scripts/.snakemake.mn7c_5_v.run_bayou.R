...
snakemake <- Snakemake(
    input = list('data/t10_N100_clade0.2_b1.5_d0.5_rate10.trait', 'config_files/pr1.bayou', "trait_f" = 'data/t10_N100_clade0.2_b1.5_d0.5_rate10.trait', "prior_f" = 'config_files/pr1.bayou'),
    output = list('t10_N100_clade0.2_b1.5_d0.5_rate10_pr1.bayou', 'out/bayou/t10_N100_clade0.2_b1.5_d0.5_rate10_pr1.summary.txt', "checkpoint" = 't10_N100_clade0.2_b1.5_d0.5_rate10_pr1.bayou', "ch_sum" = 'out/bayou/t10_N100_clade0.2_b1.5_d0.5_rate10_pr1.summary.txt'),
    params = list(),
    wildcards = list('t10_N100_clade0.2_b1.5_d0.5_rate10', '1', "sample" = 't10_N100_clade0.2_b1.5_d0.5_rate10', "n" = '1'),
    threads = 1,
    log = list('log/t10_N100_clade0.2_b1.5_d0.5_rate10_pr1.bayou.log'),
    resources = list(),
