...
snakemake <- Snakemake(
    input = list('data/t6_N200_clade0.2_b1.5_d0.5_rate10.trait', 'config_files/pr1.bayou', "trait_f" = 'data/t6_N200_clade0.2_b1.5_d0.5_rate10.trait', "prior_f" = 'config_files/pr1.bayou'),
    output = list('t6_N200_clade0.2_b1.5_d0.5_rate10_pr1.bayou', 'out/bayou/t6_N200_clade0.2_b1.5_d0.5_rate10_pr1.summary.txt', "checkpoint" = 't6_N200_clade0.2_b1.5_d0.5_rate10_pr1.bayou', "ch_sum" = 'out/bayou/t6_N200_clade0.2_b1.5_d0.5_rate10_pr1.summary.txt'),
    params = list(),
    wildcards = list('t6_N200_clade0.2_b1.5_d0.5_rate10', '1', "sample" = 't6_N200_clade0.2_b1.5_d0.5_rate10', "n" = '1'),
    threads = 1,
    log = list('log/t6_N200_clade0.2_b1.5_d0.5_rate10_pr1.bayou.log'),
    resources = list(),
