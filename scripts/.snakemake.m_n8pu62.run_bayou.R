...
snakemake <- Snakemake(
    input = list('data/t8_N400_clade0.2_b1.5_d0.5_rate10.trait', 'config_files/pr1.bayou', "trait_f" = 'data/t8_N400_clade0.2_b1.5_d0.5_rate10.trait', "prior_f" = 'config_files/pr1.bayou'),
    output = list('t8_N400_clade0.2_b1.5_d0.5_rate10_pr1.bayou', 'out/bayou/t8_N400_clade0.2_b1.5_d0.5_rate10_pr1.summary.txt', "checkpoint" = 't8_N400_clade0.2_b1.5_d0.5_rate10_pr1.bayou', "ch_sum" = 'out/bayou/t8_N400_clade0.2_b1.5_d0.5_rate10_pr1.summary.txt'),
    params = list(),
    wildcards = list('t8_N400_clade0.2_b1.5_d0.5_rate10', '1', "sample" = 't8_N400_clade0.2_b1.5_d0.5_rate10', "n" = '1'),
    threads = 1,
    log = list('log/t8_N400_clade0.2_b1.5_d0.5_rate10_pr1.bayou.log'),
    resources = list(),
