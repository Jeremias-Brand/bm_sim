...
snakemake <- Snakemake(
    input = list('data/t1_N400_clade0.2_b1.5_d0.5_rate10.trait', 'config_files/pr1.bayou', "trait_f" = 'data/t1_N400_clade0.2_b1.5_d0.5_rate10.trait', "prior_f" = 'config_files/pr1.bayou'),
    output = list('t1_N400_clade0.2_b1.5_d0.5_rate10_pr1.bayou', 'out/bayou/t1_N400_clade0.2_b1.5_d0.5_rate10_pr1.summary.txt', "checkpoint" = 't1_N400_clade0.2_b1.5_d0.5_rate10_pr1.bayou', "ch_sum" = 'out/bayou/t1_N400_clade0.2_b1.5_d0.5_rate10_pr1.summary.txt'),
    params = list(),
    wildcards = list('t1_N400_clade0.2_b1.5_d0.5_rate10', '1', "sample" = 't1_N400_clade0.2_b1.5_d0.5_rate10', "n" = '1'),
    threads = 1,
    log = list('log/t1_N400_clade0.2_b1.5_d0.5_rate10_pr1.bayou.log'),
    resources = list(),
    config = list("n_sim" = 100, "n_tips" = c(10, 50, 100, 200, 400), "rates" = c(1, 2, 5, 10, 100, 1000), "clade_size" = c(0.2), "birth" = 1.5, "death" = 0.5, "sel_n_sim" = 1, "sel_n_tips" = c(10, 50, 100, 200, 400), "sel_clade" = c(0.2), "sel_rate" = c(10), "sel_prior_set" = c(1), "sel_tool" = c('bayou', 'bt', 'bamm'), "n_gen" = 10000, "burnin" = 0.3, "n_chains" = 2, "mcmc_write_freq" = 1000, "mcmc_print_freq" = 1000000, "mcmc_event_freq" = 10),
    rule = 'run_bayou'
)
######## Original script #########
library(bayou)
